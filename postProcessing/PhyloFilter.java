...
public class PhyloFilter extends Phylogenetic{
	...
	public PhyloFilter(String phyloFile,String orgFile,String outputPath) {
		// TODO Auto-generated constructor stub
		super(phyloFile,orgFile);
		this.outputPath = outputPath;
	}

	public PhyloFilter(String phyloFile,String orgFile) {
		// Default value for outputPath used (append _filtered to input filename).
		super(phyloFile,orgFile);
		this.outputPath = Utils.stripExtension(phyloFile) + "_filtered.phylo";
	}
